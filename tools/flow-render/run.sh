...
echo "== rrev 렌더 스모크 (좌표·NaN·이탈) =="
node tools/flow-render/rrev-smoke.js static/flow/rrev.js
echo "== rrev 의미 검사 (그림이 참말을 하나) =="
node tools/flow-render/rrev-assert.js static/flow/rrev.js
echo "== nextra 이식 모듈 ↔ Hugo 엔진 패리티 (rstep·rrev) =="
