...
|---|---|---|
| [HyperDX 직접 운영하기]({{< relref "../hyperdx-operating/_index.md" >}}) | **운영 트랙(6부, 별도 챕터)** — 아래 정본 문서들 위에서 "직접 운영하려면 어떤 순서로 무엇을 판단해야 하나"를 ①아키텍처 ②티어링 ③가용성 ④operator 패턴 ⑤규모 산정 ⑥의사결정 가이드로 실체화 | 남김없는 세부·근거는 아래 정본 01~09·출처 10 |
