...
- **용량/비용**: **월 0.7TB(on-disk 해석)** 기준 **1 shard × RF2** 로 1년+ 충분. hot·컴퓨트는 지평 무관 고정, 3→12개월 증분은 대부분 싼 S3 cold. prod 월 **~$1.0~1.4K** `[추정]`(us-east-1 기준, 서울 ~10~15%↑).
{{< /callout >}}
...
| 용량·비용 | on-disk 해석 1차, 지평별(3/6/12개월) 워크드 모델 | hot·컴퓨트 고정 + 증분은 S3 cold `[추정]` → {{< relref "07-capacity-planning.md" >}} |
