...
이 챕터는 [KubeCon + CloudNativeCon Europe 2026 세션](https://kccnceu2026.sched.com/event/2CW5d) *Scaling Valkey the Right Way: Kubernetes at XL Scale*(Sarthak Aggarwal · Madelyn Olson, AWS ElastiCache) 한 편을 다룹니다. 발표가 내놓는 것은 두 가지입니다. Valkey cluster 모드는 2,000노드·1B RPS까지 올라갑니다. 거기까지 가는 동안 실제로 부러진 곳이 네 곳 있었습니다 — 재접속 폭풍, failure report O(N), 투표 분열, pub/sub 헤더. 부러진 자리마다 업스트림 PR을 함께 보여줍니다.
