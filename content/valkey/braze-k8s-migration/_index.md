...
이 챕터가 다루는 발표는 [Joe Heyburn](https://kccnceu2026.sched.com/event/2CW6D/redis-on-ec2-to-valkey-on-kubernetes-a-zero-downtime-case-study-joe-heyburn-braze)(Braze)의 KubeCon + CloudNativeCon Europe 2026 세션 *Redis on EC2 to Valkey on Kubernetes: A Zero-Downtime Case Study*입니다. 앞 세션과 같은 방에서 바로 다음 순서로 이어졌습니다. 자매 챕터 [① 2,000노드 Valkey 클러스터]({{< relref "../cluster-xl-scale/_index.md" >}})가 EC2 벤치마크(1B RPS, 짧은 측정 구간)였다면 이 챕터는 반대편입니다 — 2023년 2월부터 2024년 5월까지 Kubernetes 이관을 마치고 그 뒤로도 계속 돌아간 **프로덕션 실적**입니다.
