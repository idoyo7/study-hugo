...
토폴로지도 다릅니다. AWS 발표가 gossip·16384 슬롯의 단일 거대 클러스터를 말했다면 Braze는 Valkey Cluster를 아예 쓰지 않습니다. **Sentinel 기반 HA 샤드 581개**를 독립적으로 굽니다. 샤딩은 서버가 아니라 클라이언트 쪽 해싱이 담당합니다. 규모는 **36M ops/sec**, 메모리 총량 **6.6TiB** — 벤치마크가 아니라 실운영 수치입니다.
