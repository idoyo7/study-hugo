...
입구가 둘입니다. 위 줄에서는 브라우저가 공인 도메인으로 클러스터의 관문을 지나 호스트의 code-server에 닿습니다. 아래 줄에서는 아이패드가 Anthropic 릴레이를 거쳐 같은 호스트의 Claude Code에 붙습니다. 어느 쪽으로 들어와도 호스트 한 대의 같은 tmux 세션에서 만나고 파일은 NAS에 있습니다. 클러스터 안쪽과 아이패드 쪽은 아래에서 하나씩 폅니다.
