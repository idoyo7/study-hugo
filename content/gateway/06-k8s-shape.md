...
> **왜 이 문서인가.** "StatefulSet이나 headless service로 정의해야 하나"라는 질문에 답하고, 그보다 훨씬 자주 사고를 내는 **종료 설계**를 다룹니다. 장수명 연결 게이트웨이에서 배포는 평시 최대 부하 이벤트다 — 아무것도 안 하면 배포할 때마다 5만 대가 동시에 재접속합니다.
