...
> 공식 문서와 릴리스 블로그는 "무엇이 있다"까지만 말해줍니다. **"우리 클러스터에서 지금 써도 되는가"** 는 말해주지 않습니다. 이 챕터는 운영에 실제로 영향을 주는 Kubernetes 주제를 골라 **구현이 실제로 하는 일·리포팅된 버그·케이스별 득실**까지 내려갑니다. 설명이 목표가 아닙니다. "쓸지 말지, 쓴다면 어디에"를 판단할 수 있는 수준이 목표입니다.
