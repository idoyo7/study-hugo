...
- **[06 Python GIL × CPU Limit]({{< relref "06-python-gil-cfs" >}})** · 모든 k8s · CPython — "1코어 런타임"은 왜 잘리는가. quota는 코어당 지분이 아니라 시간 예산 풀이라 limit ≥ 1코어인 GIL 프로세스는 잘릴 수 없다 — 잘린다면 워커 다중화·네이티브 스레드풀·서브코어 limit·free-threading 넷 중 하나다.
