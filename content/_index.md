...
- **[EKS 버전 업그레이드]({{< relref "eks-upgrade/_index.md" >}})** — finance 클러스터 EKS 1.30→1.35 blue-green 이관 실전 기록: 허브-스포크 GitOps+CAPI 아키텍처와 진단, in-place→CAPI복구→blue-green 3단계 변천 서사, Fargate+karpenter 토폴로지, Terraform 클러스터 생성, managed addon·컴포넌트별 마이그레이션.
