...
| 2 | **vmbackup을 "쿼리 가능한 아카이브"로 착각** | S3 백업은 콜드 사본 — 조회하려면 vmstorage/vmsingle을 정지하고 vmrestore로 전체 복원해야 한다. 재조사용 저장소가 될 수 없다 (→ [VM 챕터 07 vmbackup/vmrestore]({{< relref "../victoriametrics/practice/02-operations-at-scale.md" >}})) |
