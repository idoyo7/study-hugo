...
**스토리지 클래스**: 본 분석의 sc1은 "최저가 옵션"일 뿐, **시작은 gp3(기본값)가 맞습니다.** 아카이브 볼륨이 작아(0.9~2.7 TiB) gp3 프리미엄이 월 $66~199 수준이므로 검증 기간엔 gp3로 안전하게 가고, 이후 IO 실측을 보고 st1/sc1 최적화를 판단합니다. 단가·볼륨 선택 상세는 [06번]({{< relref "06-storage-pricing.md" >}}).
