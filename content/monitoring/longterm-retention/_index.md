...
과거 장애를 다시 파헤치려면 그때 메트릭이 남아 있어야 합니다. 이 챕터는 메트릭 400일 보관을 놓고 아키텍처 후보를 비교해 권장안까지 정리합니다. 옵션마다 비용·구성·제약을 같은 축에 올려두고 VM OSS 아카이브안이 이 조건에서 최적인 이유까지 짚습니다.
...
- 5m 해상도는 >90d 구간에서 허용합니다 — 이 한 줄에서 비용이 자릿수로 갈립니다.
