...
이 섹션의 문서는 전부 아래 네이버 D2 발표·기사 4건을 읽고 재구성한 요약입니다. 원문 자체가 아니므로 정확한 내용은 각 링크에서 확인합니다.
...
이 섹션의 목적은 보존입니다. 같은 지식을 주제 축으로 재배열하지 않고 각 원문이 실제로 무엇을 말했는지 그대로 승계합니다. 원문 한 건에 문서 한 편을 대응시켰으니 발표·기사의 흐름과 강조점이 흐트러지지 않습니다.
