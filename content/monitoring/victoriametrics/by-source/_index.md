...
이 섹션의 모든 문서는 아래 네이버 D2 발표·기사 4건을 읽고 재구성한 요약입니다. 원문 자체가 아니며, 정확한 원문은 각 링크에서 확인합니다.
...
같은 지식을 주제로 재배열하지 않고, 각 원문이 실제로 무엇을 말했는지 그대로 승계해 보존하는 것이 이 섹션의 목적입니다. 원문 한 건 = 문서 한 편으로 대응해, 발표·기사의 흐름과 강조점을 훼손하지 않습니다.
...
01은 DEVIEW 2023 발표를 기반으로 한 기사입니다.

## 주제별로 보기

원리가 궁금하면 [기본 개념]({{< relref "../concepts/_index.md" >}}), 설계·운영 패턴이 궁금하면 [잘 쓰는 방법]({{< relref "../practice/_index.md" >}}), 우리 환경 적용 사례가 궁금하면 [우리의 운영]({{< relref "../ours/_index.md" >}})을 봅니다.

## 읽는 순서

시간순으로 01 → 02 → 03 → 04가 자연스럽습니다. 04(운영기 2편)는 같은 시리즈인 02(운영기 1편)를 먼저 읽으면 맥락이 더 잘 잡힙니다.
