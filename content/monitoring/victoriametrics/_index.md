...
- 압축이 곧 TSDB의 본질입니다. Time Series와 Sample을 분리(IndexDB/DataDB)하고 Gauge엔 Delta·Counter엔 Delta-of-Delta를 얹어 압축률을 극단까지 끌어올립니다. → [기본 개념 04]({{< relref "concepts/04-storage-and-compression.md" >}})
