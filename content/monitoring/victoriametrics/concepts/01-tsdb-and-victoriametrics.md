...
- 자체 벤치마크 기준으로 **메모리 5배, 스토리지 7배 더 효율적**이라고 주장합니다. 이 효율의 비결은 앞서 본 Time Series/Sample 분리와 Gorilla 계열 압축이다. 실제 운영에서는 데이터포인트당 1바이트 미만까지 줄어든다(상세는 [04 저장과 압축]({{< relref "04-storage-and-compression.md" >}})).
