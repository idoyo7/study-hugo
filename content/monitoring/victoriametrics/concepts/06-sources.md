...
문서는 요약·재구성본입니다. 발표자의 정확한 워딩, 타임스탐프, 맥락이 필요하면 작업 저장소 `evejuni/monitoring/d2-victoriametrics/`의 `01_대사집_*.md`, `02_대사집_*.md`를 보십시오(GitBook 미포함). 두 대사집은 5분 단위 타임스탐프(`## 00:00 ~`)로 구획돼 있어 영상과 대조하기 쉽습니다.
