...
컨트롤 플레인 설정은 성격이 다른 세 층으로 갈립니다. 층을 섞어 읽으면 "무엇을 언제 정할 수 있는가"가 흐려지므로 페이지도 층 단위로 나눴습니다.
