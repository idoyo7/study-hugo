...
{{< callout type="info" >}}
**한눈에**
- 결정축은 **3–3(+ 워크로드 의존 2축)** — 무조건적인 승자는 없고 워크로드 shape가 답을 정합니다.
...
- 둘 다 BM25/relevance 스코어링이 없습니다 — ES식 랭킹 검색이 진짜 필요하면 전용 검색층을 별도로 남겨야 합니다.
{{< /callout >}}

둘을 정면 비교하면 결정축은 **3–3(+ 워크로드 의존 2축)**으로 "무조건 승"이 없습니다. **워크로드 shape가 답을 정합니다.** (아래 표는 결정축 중심 요약)
