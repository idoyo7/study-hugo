...
| [로컬 NVMe 데이터스토어 벤치마킹]({{< relref "05-local-nvme-datastore-patterns.md" >}}) | ScyllaDB·Kafka·Redpanda·ES/OpenSearch·Aerospike·TiKV·CockroachDB 등 9개 시스템 횡단 비교 — "로컬 NVMe 1차 + 복제 내구성 + S3 티어링"이 업계 표준인지, ClickHouse 결정에 주는 강화 근거·신규 리스크 |
| [출처]({{< relref "06-sources.md" >}}) | 이 섹션 근거 URL 모음 |
