...
ClickHouse Inc.의 아키텍처·가격·운영 문서와 공식 블로그(제품·설계 설명만, 다른 회사 사례는 제외).
...
- docs — Upgrade(버전 롤링 업그레이드 절차·mixed-version 호환 창) — [clickhouse.com/docs/operations/update](https://clickhouse.com/docs/operations/update)
- docs — Scaling clusters(shard 자동 리밸런싱 없음) — [clickhouse.com/docs/guides/sre/scaling-clusters](https://clickhouse.com/docs/guides/sre/scaling-clusters)
- GitHub issue — shard rebalancing 미지원 #33947 — [github.com/ClickHouse/ClickHouse/issues/33947](https://github.com/ClickHouse/ClickHouse/issues/33947)
...
Altinity 자체 문서/저장소, ClickHouse Inc. 공식 operator, 대안 operator(KubeBlocks·KubeDB), Bitnami 정책 변경 자료.
...
- issue #1926(v0.24.3 이미지+설정 동시변경 crash) — [github.com/Altinity/clickhouse-operator/issues/1926](https://github.com/Altinity/clickhouse-operator/issues/1926)
- PR #1956(#1926 수정 — reconcile 순서 변경) — [github.com/Altinity/clickhouse-operator/pull/1956](https://github.com/Altinity/clickhouse-operator/pull/1956)
- PR #1124(staged rollout — 첫 shard 순차 probe 구현) — [github.com/Altinity/clickhouse-operator/pull/1124](https://github.com/Altinity/clickhouse-operator/pull/1124)
- issue #2026(0.27.0 aborted reconcile 자동 재개 범위) — [github.com/Altinity/clickhouse-operator/issues/2026](https://github.com/Altinity/clickhouse-operator/issues/2026)
- Altinity/clickhouse-operator release_notes.md — [github.com/Altinity/clickhouse-operator/.../release_notes.md](https://github.com/Altinity/clickhouse-operator/blob/master/release_notes.md)
- Altinity/clickhouse-operator CHANGELOG.md — [github.com/Altinity/clickhouse-operator/.../CHANGELOG.md](https://github.com/Altinity/clickhouse-operator/blob/master/CHANGELOG.md)
- Altinity/clickhouse-operator GitHub Releases — [github.com/Altinity/clickhouse-operator/releases](https://github.com/Altinity/clickhouse-operator/releases)
- Altinity docs — operator 홈(현재 버전 고지) — [docs.altinity.com/altinitykubernetesoperator](https://docs.altinity.com/altinitykubernetesoperator/)
- Altinity docs — operator upgrade(minor 단계별·CRD 삭제 금지) — [docs.altinity.com/altinitykubernetesoperator/upgrade](https://docs.altinity.com/altinitykubernetesoperator/upgrade/)
- Altinity docs — operator_upgrade.md(버전별 업그레이드 노트) — [github.com/Altinity/clickhouse-operator/.../operator_upgrade.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/operator_upgrade.md)
- Altinity docs — replication_setup.md(layout/Keeper 연결 방식) — [github.com/Altinity/clickhouse-operator/.../replication_setup.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/replication_setup.md)
- Altinity docs — custom_resource_explained.md — [github.com/Altinity/clickhouse-operator/.../custom_resource_explained.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/custom_resource_explained.md)
- Altinity Kubernetes Quickstart — Adding a Second Shard — [docs.altinity.com/.../adding-a-second-shard](https://docs.altinity.com/altinitykubernetesoperator/kubernetesquickstartguide/adding-a-second-shard/)
...
- ClickHouse — DB 단위 attach 깨짐(25.11.2.24, `unfinished code`) #93579 — [github.com/ClickHouse/ClickHouse/issues/93579](https://github.com/ClickHouse/ClickHouse/issues/93579)
- ClickHouse — `plain_rewritable` 테이블 생성 실패 회귀(25.8.1) #87281 — [github.com/ClickHouse/ClickHouse/issues/87281](https://github.com/ClickHouse/ClickHouse/issues/87281)
- ClickHouse — `plain_rewritable` 관련 이슈 #70937 — [github.com/ClickHouse/ClickHouse/issues/70937](https://github.com/ClickHouse/ClickHouse/issues/70937)
- ClickHouse — `plain_rewritable` 관련 이슈 #70154 — [github.com/ClickHouse/ClickHouse/issues/70154](https://github.com/ClickHouse/ClickHouse/issues/70154)
- ClickHouse — #87281 대응 PR #89796 — [github.com/ClickHouse/ClickHouse/pull/89796](https://github.com/ClickHouse/ClickHouse/pull/89796)
- ClickHouse — `plain_rewritable` 계열 PR #63365 — [github.com/ClickHouse/ClickHouse/pull/63365](https://github.com/ClickHouse/ClickHouse/pull/63365)
- ClickHouse — readonly part refresh(`refresh_parts_interval`·`table_disk`, 25.4) PR #76467 — [github.com/ClickHouse/ClickHouse/pull/76467](https://github.com/ClickHouse/ClickHouse/pull/76467)

라이터 failover(leader election):

- ClickHouse — 라이터 리더 선출 요구 이슈(2025-12-06) #91613 — [github.com/ClickHouse/ClickHouse/issues/91613](https://github.com/ClickHouse/ClickHouse/issues/91613)
- ClickHouse — 오브젝트 스토리지 조건부 쓰기 lease 기반 `leader_election`(2026-08-09 open) PR #101039 — [github.com/ClickHouse/ClickHouse/pull/101039](https://github.com/ClickHouse/ClickHouse/pull/101039)

zero-copy replication 현행 상태:

- ClickHouse master — `MergeTreeSettings.cpp`(zero-copy 설정의 `EXPERIMENTAL` 등급 원문) — [github.com/ClickHouse/ClickHouse/blob/master/src/Storages/MergeTree/MergeTreeSettings.cpp](https://github.com/ClickHouse/ClickHouse/blob/master/src/Storages/MergeTree/MergeTreeSettings.cpp)
- ClickHouse — 공유 blob 조기 삭제 회귀(26.2) #95597 — [github.com/ClickHouse/ClickHouse/issues/95597](https://github.com/ClickHouse/ClickHouse/issues/95597)
- ClickHouse — zero-copy 환경에서 drop 영구 정지 #96965 — [github.com/ClickHouse/ClickHouse/issues/96965](https://github.com/ClickHouse/ClickHouse/issues/96965)
- ClickHouse — zero-copy 관련 이슈 #85203 — [github.com/ClickHouse/ClickHouse/issues/85203](https://github.com/ClickHouse/ClickHouse/issues/85203)
- ClickHouse — merge 무한 정지 인시던트(22.3·4 replica·S3) #45346 — [github.com/ClickHouse/ClickHouse/issues/45346](https://github.com/ClickHouse/ClickHouse/issues/45346)
- ClickHouse — mutation 중 데이터 손실 #39560 — [github.com/ClickHouse/ClickHouse/issues/39560](https://github.com/ClickHouse/ClickHouse/issues/39560)
...
- ClickHouse Private(자체 인프라에서 SharedMergeTree, AWS GA·GCP preview) — 제품 페이지 URL 미확보 `?`. 공개된 접점은 영업 문의뿐입니다. 요금·최소 커밋은 확인하지 못했습니다.
- ClickHouse 블로그 — stateless compute · Shared Catalog 계열 포스트 — 개별 포스트 URL 미확보 `?`. 본문은 부품 존재 사실만 인용하고 수치를 쓰지 않습니다.

## 데이터스토어 횡단 벤치마킹

[데이터스토어 횡단 벤치마킹]({{< relref "07-local-nvme-datastore-patterns.md" >}}) 페이지의 근거인 로컬 NVMe 1차 스토리지 조사(ScyllaDB·Cassandra / Kafka·스트리밍 / Elasticsearch·OpenSearch / Aerospike·LSM-KV) `## 출처`에서 시스템군별 대표 URL을 선별했습니다(전량 아님 — 각 시스템군의 1차·핵심 근거 위주). 전체 목록은 원 조사 문서(11-1~11-4) 참조.
